...
# Taken from https://github.com/NVIDIA/tao_tensorflow1_backend/blob/c7a3926ddddf3911842e057620bceb45bb5303cc/nvidia_tao_tf1/cv/retinanet/layers/output_decoder_layer.py#L1
...
class DecodeDetections(tf.keras.layers.Layer):
    """
...
`img_height == {}` and `img_width == {}`".format(
    ...
    def compute_output_shape(self, input_shape):
        ...
        return (
            ...
            self.top_k,
            6,
        )  # Last axis: (cls_ID, confidence, 4 box coordinates)
